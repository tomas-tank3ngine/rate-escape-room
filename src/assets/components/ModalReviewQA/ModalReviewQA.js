    ...
    return (
        <div className={`modal-review-qa ${isOpen ? "open" : "closed"}`}>
            <div className="modal-review-qa__content">
                <h2 className="modal-review-qa__title">
                    Escape Room Experience Questionnaire
                </h2>
                ...
                <div className="modal-review-qa__question">
                    <p className="modal-review-qa__question-text">
                        1. The room's atmosphere and set design were immersive
                        and eye-catching.
                    </p>
                    <div className="modal-review-qa__rating">
                        {[
                            ...
                            <label
                                htmlFor={`${value}-atmosphere`}
                                key={value}
                                className="modal-review-qa__rating-label"
                            >
                                <input
                                    type="radio"
                                    ...
                                    value={value}
                                    checked={
                                        ratings.atmosphere_rating === value
                                    }
                                    onChange={() =>
                                        handleRatingChange(
                                            "atmosphere_rating",
                                ...
                                />
                                <span className="modal-review-qa__rating-value">
                                    {value}
                                </span>
                            </label>
                        ))}
                ...
                <div className="modal-review-qa__question">
                    <p className="modal-review-qa__question-text">
                        3. The technology used in the room was impressive; I
                        ...
                        {[
                            ...
                            >
                                <input
                                    ...
                                    onChange={() =>
                                        handleRatingChange("tech_rating", value)
                                    }
                                    className="modal-review-qa__rating-input"
                                />
                                <span className="modal-review-qa__rating-value">
                ...
                <div className="modal-review-qa__question">
                    <p className="modal-review-qa__question-text">
                        4. The puzzles were fair and enjoyable; I felt like I
                        had a good chance to solve them without any help.
                    </p>
                    <div className="modal-review-qa__rating">
                        {[
                            "strongly disagree",
                            ...
                            >
                                <input
                                    ...
                                    value={value}
                                    checked={
                                        ratings.puzzle_fairness_rating === value
                                    }
                                    onChange={() =>
                                        handleRatingChange(
                ...
                <div className="modal-review-qa__buttons">
                    <button
                        className="modal-review-qa__button--submit"
                        onClick={handleSubmit}
                    >
                        Submit
                    </button>
                    <button
                        className="modal-review-qa__button--cancel"
                        onClick={onClose}
                    >
                        Cancel
                    </button>
